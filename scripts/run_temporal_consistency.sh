...
mkdir -p logs
run_tag="temporal_consistency_v1_$(date -u +%Y%m%d_%H%M%S)"

# Defaults match the supplied MobileNetV2 prototype experiment. Extra CLI
# arguments can override defaults, including source/target paths and run_name.
python train.py \
